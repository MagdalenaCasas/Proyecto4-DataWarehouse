...
const displayCompanias= (companias)=>{
 ...
 <td>
    <div class='actions'>
        ...
        <span data-id=${compania.id} data-nombre=${compania.nombre} class='remove-company'><i class="fas fa-trash remove-company" data-id=${compania.id} data-nombre=${compania.nombre}></i></span>
    </div>
</td>
</tr>
 ...
 btnEliminar.forEach(btn =>{
  ...
  btn.addEventListener("click",async ()=>{
    ...
    h2.innerText = `¿Estas seguro que deseas eliminar la compañia ${nombre}?`
